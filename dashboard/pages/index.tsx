...
const styles = {
  container: { maxWidth: 960, margin: "0 auto", padding: "40px 24px" } as React.CSSProperties,
  header: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 32 } as React.CSSProperties,
  title: { fontSize: 24, fontWeight: 700, color: "#f0f6fc" } as React.CSSProperties,
  subtitle: { fontSize: 14, color: "#8b949e", marginTop: 4 } as React.CSSProperties,
  card: { background: "#161b22", border: "1px solid #21262d", borderRadius: 8, padding: "20px 24px", marginBottom: 12, transition: "border-color 0.2s", cursor: "pointer" } as React.CSSProperties,
  cardTitle: { fontSize: 16, fontWeight: 600, color: "#f0f6fc", marginBottom: 8 } as React.CSSProperties,
  cardMeta: { display: "flex", gap: 24, fontSize: 13, color: "#8b949e", flexWrap: "wrap" } as React.CSSProperties,
  badge: { display: "inline-block", padding: "2px 8px", borderRadius: 12, fontSize: 12, fontWeight: 600 } as React.CSSProperties,
  statusColors: {
  ...
  empty: { textAlign: "center", padding: 80, color: "#8b949e" } as React.CSSProperties,
  refreshBtn: { background: "#21262d", color: "#c9d1d9", border: "1px solid #30363d", borderRadius: 6, padding: "8px 16px", fontSize: 13 } as React.CSSProperties,
};
          ...
          <a key={s.id} href={`/session/${s.id}`} style={{ textDecoration: "none" }}>
            <div style={styles.card}
              ...
              <div style={styles.cardMeta}>
                <span><span style={{ ...styles.badge, backgroundColor: colors.bg, color: colors.color }}>{s.status}</span></span>
